...
//OpenAi || ChatGpt
global.OpenAIKey = "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" //login to https://beta.openai.com/ to get apikey
...
// beli apikey premium pc wa: 0887435047326
global.APIKeys = {
   'https://api.zeeoneofc.my.id': 'aYySjhgA', // 👉 login https://api.zeeoneofc.my.id to get apikey
}
global.sewabotnya = `wa.me/6281226306638`
// setting 
...
// Other
// Other
global.botname = "Ｃｙａ Ｂｏｔｚ Ｍｄ "//namabot kalian
...
global.premium = ['4745533441'] //premium user
...
global.ownernomerr = "+62812261306638" //nmr wa kalian
...
global.packname = '© Ｃｙａ Ｂｏｔｚ Ｍｄ' //sticker wm ubah
global.author = 'Ƈαԋყσ ʂƚσɾҽ' //sticker wm ganti nama kalian
...
global.mess = {
   ...
   admin: 'Apakah Kamu Admin? 😒!',
   botAdmin: 'Aku Belom Jadi Admin Kak ☹️ !',
   owner: 'Command Ini Khusus Ownerku Tersayang 🥰 !',
   group: 'Comannd Ini Khusus Di Group 😑 !',
   private: 'Command Ini Khusus Di Private Chat 🤫 !',
   bot: 'Command Khusus Ｃｙａ Ｂｏｔｚ 🤭',
   errtoimg: 'Maaf Tidak Support Stiker Gif !',
   wait: 'Perimintaan Anda Sedang Di Proses Kak Mohon Di Tunggu 🤤',
   lockCmd: 'Command Ini Tidak Di Akrifkan Oleh Ownerku Tersayang 🥰!',
